...
# SONG PAGE -> REDIRECTS TO CORRESPONDING ALBUM PAGE
@app.route('/song/<sid>')
def viewSong(sid=""):
...
# EPISODE PAGE -> REDIRECTS TO CORRESPONDING PODCAST PAGE
...
# GET WHETHER A PLAYLIST IS LIKED
...
# GET SEARCH RESULTS FOR ONLY SONGS
